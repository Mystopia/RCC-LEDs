...
String filename = "/Users/Joe/Downloads/JoeinSpace.mp4";
...
void setup()
{
  ...
  opc.ledGrid(0, 128, 10, width/2, height/2, width / 70.0, height/20.0, 0, false);
...
void draw()
{
  ...
  pyramid[0].image(movie, x-64, y, mWidth, mHeight);
  pyramid[0].endDraw();
